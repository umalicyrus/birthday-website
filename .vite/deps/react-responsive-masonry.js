...
//#endregion
//#region node_modules/react-responsive-masonry/es/Masonry/index.js
...
var Masonry = /* @__PURE__ */ function(_React$Component) {
	...
	_proto.distributeChildren = function distributeChildren() {
		...
		if (!this.state.childRefs.every(function(ref) {
		...
		import_react.Children.forEach(children, function(child) {
			if (child && import_react.isValidElement(child)) {
	...
	Masonry.getEqualCountColumns = function getEqualCountColumns(children, columnsCount) {
		...
		import_react.Children.forEach(children, function(child) {
			if (child && import_react.isValidElement(child)) {
				...
				childRefs.push(ref);
				columns[validIndex % columnsCount].push(/* @__PURE__ */ import_react.createElement("div", {
					style: {
						display: "flex",
	...
	_proto.renderColumns = function renderColumns() {
		...
		return this.state.columns.map(function(column, i) {
			return import_react.createElement(itemTag, {
				key: i,
				style: _extends({
					display: "flex",
	...
	_proto.render = function render() {
		...
		return import_react.createElement(containerTag, {
			style: _extends({
				display: "flex",
				flexDirection: "row",
...
//#endregion
//#region node_modules/react-responsive-masonry/es/ResponsiveMasonry/index.js
var DEFAULT_COLUMNS_COUNT = 1;
var DEFAULT_GUTTER = "10px";
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react.useLayoutEffect : import_react.useEffect;
var useHasMounted = function useHasMounted() {
	var _useState = (0, import_react.useState)(false), hasMounted = _useState[0], setHasMounted = _useState[1];
...
var useWindowWidth = function useWindowWidth() {
	...
	var _useState2 = (0, import_react.useState)(typeof window !== "undefined" ? window.innerWidth : 0), width = _useState2[0], setWidth = _useState2[1];
	var handleResize = (0, import_react.useCallback)(function() {
...
var MasonryResponsive = function MasonryResponsive(_ref) {
	...
	var getResponsiveValue = (0, import_react.useCallback)(function(breakPoints, defaultValue) {
...
MasonryResponsive.propTypes = {
	children: import_prop_types.default.oneOfType([import_prop_types.default.arrayOf(import_prop_types.default.node), import_prop_types.default.node]).isRequired,
	columnsCountBreakPoints: import_prop_types.default.object,
	className: import_prop_types.default.string,
	style: import_prop_types.default.object
};
//#endregion
//#region node_modules/react-responsive-masonry/es/index.js
var es_default = Masonry;
//#endregion
export { MasonryResponsive as ResponsiveMasonry, es_default as default };
